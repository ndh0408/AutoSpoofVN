...
final class DeviceManager: ObservableObject {
    ...
    func connect() {
        ...
        if let data = engine.pairingData {
            ...
            connectionState = .error("Chưa có pairing data. Chạy ghép nối trước.")
        }
    }
    ...
    func generateDiagnostics() -> DiagnosticsReport {
        ...
        return DiagnosticsReport(
            ...
            deviceName: deviceName.isEmpty ? "Chưa biết" : deviceName,
            udid: deviceUDID.isEmpty ? "Chưa biết" : deviceUDID,
    ...
    private func syncFromEngine() {
        ...
        engine.$lastFFIError
            ...
            .sink { [weak self] error in
                ...
                if error != nil {
                    self?.connectionState = .error(error ?? "Lỗi không xác định")
                }
            }
            .store(in: &cancellables)
    }
