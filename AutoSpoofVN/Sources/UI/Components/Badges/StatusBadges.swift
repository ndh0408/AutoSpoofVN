...
struct ConnectionBadge: View {
    ...
    var body: some View {
        StatusBadge(compact ? shortLabel : state.displayName,
            ...
            .accessibilityLabel("Thiết bị: \(state.displayName)")
    }

    private var shortLabel: String {
        switch state {
        case .disconnected: return "Ngắt"
...
struct SourceBadge: View {
    ...
    var body: some View {
        StatusBadge(source.displayName, color: AppColor.accent, icon: source.icon)
            .accessibilityLabel("Nguồn: \(source.displayName)")
    }
}
...
struct SimulationStatusView: View {
    ...
    var body: some View {
        StatusBadge(showsLabel ? state.displayName : "",
            ...
            .accessibilityLabel("Trạng thái: \(state.displayName)")
    }
}
