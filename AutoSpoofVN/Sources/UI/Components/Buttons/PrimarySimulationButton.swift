...
struct PrimarySimulationButton: View {
    ...
    private var title: String {
        ...
        case .completed: return "Bắt đầu lại"
    ...
    private var accessibilityHint: String {
        switch state {
        case .running:   return "Tạm dừng mô phỏng, giữ nguyên vị trí hiện tại"
        case .paused:    return "Tiếp tục mô phỏng từ vị trí đang dừng"
        case .preparing: return "Đang chuẩn bị phiên mô phỏng"
        case .stopping:  return "Đang dừng phiên mô phỏng"
        case .failed:    return "Thử bắt đầu lại phiên vừa lỗi"
        default:         return isStartEnabled ? "Bắt đầu mô phỏng GPS" : "Chưa đủ điều kiện để bắt đầu"
        }
    }
...
struct StopSimulationButton: View {
    ...
    var body: some View {
        ...
        .accessibleButton(label: L10n.stop, hint: "Kết thúc phiên mô phỏng hiện tại")
    }
}
