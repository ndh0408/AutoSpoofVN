...
struct CurrentPositionMarker: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(isFlying ? "Vị trí máy bay đang mô phỏng" : "Vị trí đang mô phỏng")
        .onAppear {
...
struct TargetPinMarker: View {
    ...
    var body: some View {
        Image(systemName: "mappin.circle.fill")
            ...
            .accessibilityLabel("Điểm đã chọn")
    }
}
...
struct RoutinePlace: Identifiable {
    ...
    static func all(from routine: RoutineManager) -> [RoutinePlace] {
        [
            RoutinePlace(id: "home", title: "Nhà", symbol: "house.fill",
                         tint: AppColor.success, coordinate: routine.homeLocation),
            RoutinePlace(id: "work", title: "Công ty", symbol: "building.2.fill",
                         tint: AppColor.accent, coordinate: routine.workLocation),
            RoutinePlace(id: "cafe", title: "Cà phê", symbol: "cup.and.saucer.fill",
