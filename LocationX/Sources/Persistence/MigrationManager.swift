...
struct MigrationManager {
    ...
    private static let versionKey = "locationx_data_version"
    ...
    private static func migrateV0toV1() {
        if let legacy = UserDefaults.standard.string(forKey: "locationx_pairing_plist"),
           !legacy.isEmpty {
    ...
    private static func migrateV1toV2() {
        ...
        if let data = UserDefaults.standard.data(forKey: "locationx_bookmarks"),
        ...
        if let homeData = UserDefaults.standard.data(forKey: "locationx_home_location"),
           let workData = UserDefaults.standard.data(forKey: "locationx_work_location") {
